...
public class AstarPath : VersionedMonoBehaviour {
	...
	public static readonly System.Version Version = new System.Version(5, 2, 1);
	...
	IEnumerable<Progress> ScanInternal (NavGraph[] graphsToScan, bool async) {
		...
		while (true) {
			int firstNonFinished = GraphUpdateProcessor.PrepareGraphUpdatePromises(promises, async ? TimeSlice.MillisFromNow(2) : TimeSlice.Infinite);
