...
public class TargeterForEnemies : TargeterBaseClass
{
    ...
    public void SetNewTarget(Path p)
    {
        ...
        SetNewTarget(SceneObjectManager.Instance.sceneObjectGetter.GetSceneObjects(m.endPoint, sceneObjectTypeEnumsList: possibleTargetTypes, onlyDamageables: true)[0]);
